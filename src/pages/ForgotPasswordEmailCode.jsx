          ...
          <div className="form-main">
            <div className="form-header">
              ...
              <p className="form-subtitle">
                Мы отправили код на вашу почту. Введите его ниже, чтобы изменить пароль.
              </p>
            </div>
            ...
            <div className="form-footer">
              <div
                ...
                style={{ marginTop: -8, fontWeight: '600', color: '#69C3BF' }}
              >
...
export default ForgotPasswordEmailCode;